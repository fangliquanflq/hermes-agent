...
_TASK_FIELDS = tuple(
    ...
    "provider_override workflow_role completion_contract last_failure_error".split())
...
_CREATED_FIELDS = (
    "status", "workspace_kind", "workspace_path", "project_id", "workflow_role",
)
...
def _handle_create(args: dict, **kw) -> str:
    ...
    with _board(args.get("board")) as (kb, conn):
        ...
        new_tid = kb.create_task(
            ...
            workflow_role=args.get("workflow_role"),
