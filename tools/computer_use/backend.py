...
class UIElement:
    ...
    index: int                       # 0-based SOM index from cua-driver
...
class ComputerUseBackend(ABC):
    ...
    def set_value(self, value: str, element: Optional[int] = None) -> ActionResult:
        """Replace a native value (e.g. AXPopUpButton or AXTextArea content).

        `element` is the 0-based SOM index returned by a prior capture call.
        """
