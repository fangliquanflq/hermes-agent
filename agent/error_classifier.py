...
def _provider_special_cases(c: _Ctx) -> Optional[Verdict]:
    ...
    # Replayed reasoning-block 400s. Anthropic names thinking/signature mutation;
    # Kimi names the rejected opaque history field ``reasoning_details`` and its
    # invalid type. Not gated on provider because compatible proxies relay both.
    ...
    if status == 400 and reasoning_replay_rejected:
