...
def build_cron_parser(subparsers, *, cmd_cron: Callable) -> None:
    ...
    cron_create.add_argument(
        "--script",
        help=(
            "Path relative to the profile-scoped <HERMES_HOME>/scripts/ "
            "directory for the active profile. Default mode: "
    ...
    cron_create.add_argument(
        ...
        dest="monitor_script",
        help=(
            "Monitor mode: path relative to the profile-scoped "
            "<HERMES_HOME>/scripts/ directory for the active profile that runs "
            "each tick BEFORE the agent. "
    ...
    cron_edit.add_argument(
        ...
        help=(
            "Path relative to the profile-scoped <HERMES_HOME>/scripts/ "
            "directory for the active profile. Pass empty string to clear. "
