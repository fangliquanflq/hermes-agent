...
DEFAULT_CONFIG = {
    ...
    "kanban": {
        ...
        # Poll and deliver this profile's notification subscriptions from its gateway. Disable on
        # profiles that never own notification subscriptions to avoid an idle five-second poll.
