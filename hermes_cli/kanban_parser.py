...
_SPECS = [
    ...
    _cmd("swarm", [
        ...
        _arg("--worker-goal", action="store_true",
             help="Run every worker card in a goal loop"),
        _arg("--worker-goal-max-turns", type=int, metavar="N",
             help="Turn budget for --worker-goal cards (default 20)"),
