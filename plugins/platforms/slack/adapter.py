...
# Message events generated by Slack itself rather than by a person speaking. Keep this a
# denylist: human-authored subtypes such as file_share, me_message, and thread_broadcast must
# continue through the normal wake rules.
_NON_CONVERSATIONAL_MESSAGE_SUBTYPES = frozenset({
    "channel_archive",
...
class SlackAdapter(BasePlatformAdapter):
    ...
    async def _prefilter_inbound(
        ...
        """Normalize edits, then drop replays / ignored channels / non-conversation events.
        ...
        if event.get("subtype") in _NON_CONVERSATIONAL_MESSAGE_SUBTYPES:
            return None
